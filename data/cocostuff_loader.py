...
class CocoSceneGraphDataset(Dataset):
    def __init__(self, image_dir, instances_json, stuff_json=None,
        ...
        for object_data in instances_data['annotations']:
            ...
            box_area = (w * h) / (W * H)                                              ### where they define area and control certain aspects of the bbox
        ...
        # COCO category labels start at 1, so use 0 for __image__                                 ### why? look into this.
    ...
    def __getitem__(self, index):                                           ### does this mean that they indeed generate bbox based on obj labels? Seems that way.
        """
        ...
        objs, boxes, masks = [], [], []                                                 ### init
        # obj_masks = []
        for object_data in self.image_id_to_objects[image_id]:
            objs.append(object_data['category_id'])
#            print(objs)
            x, y, w, h = object_data['bbox']                                            ### get obj data from instances or stuff
            x0 = x / WW                                                                 ### def coords
            y0 = y / HH
            x1 = (w) / WW
            y1 = (h) / HH
...
### possibly this section of the code is for generating masks which can later be displayed as in the paper.
...
# IMAGENET_MEAN = [0.485, 0.456, 0.406]                                         ### wonder how this helps?
